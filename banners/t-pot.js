...
module.exports = () => {
  ...
  ${color('235;0;120')}|_   _| |  _ \\ ___ | |_     ${color('235;0;120')}T${color('235;0;120')}-${color('235;0;120')}Pot To AbuseIPDB (v${version})
  ${color('215;0;110')}  | |   | |_) / _ \\| __|    ${color('235;0;120')}${authorMeta}
  ${color('195;0;95')}  | |   |  __/ (_) | |_     ${color('235;0;120')}${license} License
